        ...
        <div className="add-property-main-container">
            ...
            <div className="options-container-1">
                    <div
                        ...
                        className={`option ${selectedOption === "Active Property" ? "active" : ""}`}
                    ...
                    >
                     Active Property
                        ...
                        className={`option ${selectedOption === "Under Negotiation" ? "active" : ""}`}
                 ...
                 Under Negotiation
                        ...
                        <div
                        key={"Photographs"}
                        className={`option ${selectedOption === "Inactive Property" ? "active" : ""}`}
